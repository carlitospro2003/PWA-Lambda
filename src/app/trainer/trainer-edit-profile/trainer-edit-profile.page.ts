...
@Component({
  ...
  templateUrl: './trainer-edit-profile.page.html',
  styleUrls: ['./trainer-edit-profile.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
...
export class TrainerEditProfilePage implements OnInit {
    ...
    if (this.profileForm.valid) {
      ...
      try {
        ...
        if (response && response.success) {
          console.log('===========================================');
          console.log('RESPUESTA DE /editUser (TRAINER)');
          console.log('===========================================');
        ...
        console.log('===========================================');
        console.log('ERROR EN /editUser (TRAINER)');
        console.log('===========================================');
